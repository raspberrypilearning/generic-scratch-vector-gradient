In the Scratch Paint tool in Vector Mode you can fill a shape with a gradient to get interesting shading effects. A gradient gradually changes from one colour to another. 
